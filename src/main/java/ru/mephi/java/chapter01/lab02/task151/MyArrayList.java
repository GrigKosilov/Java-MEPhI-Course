...
//    }
    ...
    private class Itr implements Iterator<E> {
        int cursor = indexOfFirst;       // index of next element to return
    ...
    public E removeQueue() {
        ...
        @SuppressWarnings("unchecked") E oldValue = (E) es[indexOfFirst];
        es[indexOfFirst]=EMPTY_ELEMENTDATA;
        indexOfFirst++;
    ...
    private Object[] grow(int minCapacity) {
        int oldCapacity = elementData.length;
        if (oldCapacity > 0 || elementData != DEFAULTCAPACITY_EMPTY_ELEMENTDATA) {
            int newCapacity = newLengthQueue(oldCapacity-indexOfFirst,
                    minCapacity - (oldCapacity-indexOfFirst), /* minimum growth */
                    (oldCapacity-indexOfFirst) >> 1           /* preferred growth */);
            elementData = Arrays.copyOfRange(elementData, indexOfFirst, newCapacity);
            size=oldCapacity-indexOfFirst;
            System.out.println("1-Size was "+oldCapacity+" Deleted elements were "+indexOfFirst+" New size "+newCapacity);
        } else {
    ...
    public static int newLengthQueue(int oldLength, int minGrowth, int prefGrowth) {
        // assert oldLength >= 0
        // assert minGrowth > 0
